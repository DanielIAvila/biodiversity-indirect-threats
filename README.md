...
This repository contains the required scripts, raw data and preprocessed files for the article " XXX", available here: 

The article explores XXXX.

The structure is as follows:

    - code: ordered scripts to reproduce the flow undertaken for the article.
    - files: raw data files required at any given point by any of the scripts.
